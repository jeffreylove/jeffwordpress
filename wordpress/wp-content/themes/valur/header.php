					...
					<div class="main-featured-article">
						<div class="article-flex-container">
							...
							<div class="article-content">
								...
								<h2 style="font-size: 36px !important; line-height: 1.2; font-weight: 400; font-family: 'RecklessNeue', serif;"><a href="<?php the_permalink(); ?>" style="font-size: 32px !important; line-height: 1.1; font-weight: 300; font-family: 'RecklessNeue', serif;"><?php the_title(); ?></a></h2>
